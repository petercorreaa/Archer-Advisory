  ...
  useEffect(() => {
    ...
    function init() {
      ...
      globe = createGlobe(canvas, {
        ...
        width, height: width,
        phi: 0, theta: 0.2, dark: 1, diffuse: 2.2,
        mapSamples: 16000, mapBrightness: 14,
        baseColor: [0.18, 0.22, 0.48],
        markerColor: [0.812, 0.263, 0.169],
        glowColor: [0.06, 0.08, 0.28],
        markerElevation: 0,
      ...
      {markers.map((m) => (
        ...
        >
          <span style={{
            ...
            border: "2px solid #CF432B", borderRadius: "50%", opacity: 0,
          ...
          <span style={{
            width: 10, height: 10, background: "#CF432B", borderRadius: "50%",
            boxShadow: "0 0 0 3px #111, 0 0 0 5px #CF432B",
          }} />
        </div>
      ))}
    </div>
